...
- Date: 2026-08-28
- Hardware target: CM5 / Raspberry Pi 5 + Hailo-10H
- Runtime target: HailoRT 5.1.1.x, Python 3.11 aarch64
...
- Static verification of input, output, anchors, labels, and API path against Model Zoo v5.4.0/TAPPAS v3.29
