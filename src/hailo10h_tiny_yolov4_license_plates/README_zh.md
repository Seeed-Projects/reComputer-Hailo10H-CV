# CM5 + Hailo-10H Tiny-YOLOv4 车牌检测

本模块使用 Hailo Model Zoo v5.4.0 官方 Hailo-10H HEF，提供内置视频、USB 摄像头、图片/视频 REST 推理、MJPEG 预览和离线视频分析。
...
本地已做 Python 语法和静态元数据检查；CM5 + Hailo-10H 真实推理、输出 tensor、Docker、摄像头和坐标对齐仍需实机验收。
