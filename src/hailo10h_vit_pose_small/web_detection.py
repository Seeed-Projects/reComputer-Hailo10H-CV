...
app = FastAPI(title="reComputer ViTPose-Small Hailo-10H")
...
async def index():
    ...
    <html><head><title>reComputer ViTPose-Small · Hailo-10H</title>
    <style>
    ...
    <div class="container"><h1>ViTPose-Small · CM5 + Hailo-10H</h1>
...
def main():
    parser = argparse.ArgumentParser(description='ViTPose-Small on CM5 + Hailo-10H')
