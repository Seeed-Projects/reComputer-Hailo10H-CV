...
app = FastAPI(title="reComputer DAMO-YOLO (tinynasL35_M) Hailo-10H")
...
async def index():
    ...
    <html>
      <head>
        <title>reComputer DAMO-YOLO (tinynasL35_M) · Hailo-10H</title>
        <style>
      ...
      <body>
        <div class="container">
          <h1>DAMO-YOLO (tinynasL35_M) · CM5 + Hailo-10H</h1>
...
def main():
    parser = argparse.ArgumentParser(description='DAMO-YOLO (tinynasL35_M) on CM5 + Hailo-10H (Web Preview Mode)')
