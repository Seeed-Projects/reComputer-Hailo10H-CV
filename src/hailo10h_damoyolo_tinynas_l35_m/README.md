# DAMO-YOLO (tinynasL35_M) on Raspberry Pi 5 / CM5 + Hailo-10H
...
```bash
sudo docker build -f docker/hailo10h/damoyolo_tinynas_l35_m.dockerfile \
  -t damoyolo_tinynas_l35_m:latest \
  src/rpi5_hailo10h_damoyolo_tinynas_l35_m
```
...
The Hailo-10H HEF comes from the
[Hailo Model Zoo v5.4.0](https://github.com/hailo-ai/hailo_model_zoo/blob/master/docs/public_models/HAILO8/HAILO8_object_detection.rst)
