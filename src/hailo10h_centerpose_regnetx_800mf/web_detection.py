...
app = FastAPI(title="reComputer CenterPose RegNetX-800MF (RPi5 + Hailo-10H)")
...
async def index():
    ...
    <html>
      ...
      <body>
        <div class="container">
          <h1>CenterPose RegNetX-800MF · RPi5 + Hailo-10H</h1>
...
def main():
    parser = argparse.ArgumentParser(description='CenterPose RegNetX-800MF on RPi5 + Hailo-10H (Web Preview Mode)')
