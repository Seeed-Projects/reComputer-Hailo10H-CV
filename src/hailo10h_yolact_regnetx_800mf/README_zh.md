# YOLACT RegNetX-800MF：Raspberry Pi 5 / CM5 + Hailo-10H 实例分割
...
```bash
sudo docker build -f docker/hailo10h/yolact_regnetx_800mf.dockerfile \
  -t yolact_regnetx_800mf:latest \
  src/rpi5_hailo10h_yolact_regnetx_800mf
```
