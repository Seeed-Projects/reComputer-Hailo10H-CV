...
app = FastAPI(title="reComputer YOLACT RegNetX-800MF Hailo-10H")
...
async def index():
    ...
    <html>
      ...
      <body>
        <div class="container">
          <h1>YOLACT RegNetX-800MF · CM5 + Hailo-10H</h1>
          <div class="tabs">
...
def main():
    parser = argparse.ArgumentParser(description='YOLACT RegNetX-800MF on CM5 + Hailo-10H (Web Preview Mode)')
