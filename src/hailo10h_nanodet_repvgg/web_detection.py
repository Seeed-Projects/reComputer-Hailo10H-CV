...
app = FastAPI(title="reComputer NanoDet-RepVGG Hailo-10H")
...
async def index():
    ...
    <html>
      <head>
        <title>reComputer NanoDet-RepVGG · Hailo-10H</title>
        <style>
      ...
      <body>
        <div class="container">
          <h1>NanoDet-RepVGG · CM5 + Hailo-10H</h1>
          <div class="tabs">
...
def main():
    parser = argparse.ArgumentParser(description='NanoDet-RepVGG on CM5 + Hailo-10H (Web Preview Mode)')
