...
app = FastAPI(title="reComputer Tiny-YOLOv4 Hailo-10H")
...
async def index():
    ...
    <html><head><title>reComputer Tiny-YOLOv4 · Hailo-10H</title>
    <style>
    ...
    <div class="container"><h1>Tiny-YOLOv4 · CM5 + Hailo-10H</h1>
    ...
    if not _DET_OUTPUT_LOGGED:
        if not _DET_OUTPUT_LOGGED:
            ...
            for i, h in enumerate(heads):
                print(f"[tiny_yolov4] head{i}: shape={h.shape} "
...
def main():
    parser = argparse.ArgumentParser(description='Tiny-YOLOv4 on CM5 + Hailo-10H (Web Preview Mode)')
