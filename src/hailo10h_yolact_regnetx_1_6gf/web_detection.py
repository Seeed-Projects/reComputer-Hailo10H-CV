...
app = FastAPI(title="reComputer YOLACT RegNetX-1.6GF Hailo-10H")
...
async def index():
    ...
    <html>
      <head>
        <title>reComputer YOLACT · Hailo-10H</title>
        <style>
      ...
      <body>
        <div class="container">
          <h1>YOLACT RegNetX-1.6GF · CM5 + Hailo-10H</h1>
          <div class="tabs">
...
def main():
    parser = argparse.ArgumentParser(description='YOLACT RegNetX-1.6GF on CM5 + Hailo-10H (Web Preview Mode)')
