# YOLACT RegNetX-1.6GF：Raspberry Pi 5 / CM5 + Hailo-10H 实例分割
...
```bash
sudo docker build -f docker/hailo10h/yolact_regnetx_1_6gf.dockerfile \
  -t yolact_regnetx_1_6gf:latest \
  src/rpi5_hailo10h_yolact_regnetx_1_6gf
```
...
[Hailo Model Zoo v5.4.0](https://github.com/hailo-ai/hailo_model_zoo/blob/master/docs/public_models/HAILO8/HAILO8_instance_segmentation.rst)
