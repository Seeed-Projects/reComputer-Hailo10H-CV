...
Ported from the validated Hailo-8 module `rpi5_hailo8_nanodet_repvgg_a12`; the
...
`nanodet_repvgg_a12.hef` is the Hailo-10H build from Hailo Model Zoo v5.4.0 — see
