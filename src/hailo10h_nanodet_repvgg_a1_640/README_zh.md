# NanoDet-RepVGG-a1-640：reComputer CM5 + Hailo-10H 目标检测
...
从已验证的 Hailo-8 模块 `rpi5_hailo8_nanodet_repvgg_a1_640` 移植；执行器替换为
...
`nanodet_repvgg_a1_640.hef` 为 Hailo Model Zoo v5.4.0 的 Hailo-10H 构建——
