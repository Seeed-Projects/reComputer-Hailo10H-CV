...
app = FastAPI(title="reComputer NanoDet-RepVGG-a1-640 Hailo-10H")
...
async def index():
    ...
    <html>
      <head>
        <title>reComputer NanoDet-RepVGG-a1-640 · Hailo-10H</title>
        <style>
      ...
      <body>
        <div class="container">
          <h1>NanoDet-RepVGG-a1-640 · CM5 + Hailo-10H</h1>
          <div class="tabs">
...
def post_process_hailo(hailo_output, obj_thresh, nms_thresh, input_h, input_w):
    ...
    if not _DET_OUTPUT_LOGGED:
        ...
        print(
            f"[NanoDet-a1-640] raw output type={type(output).__name__}, "
...
def main():
    parser = argparse.ArgumentParser(description='NanoDet-RepVGG-a1-640 on CM5 + Hailo-10H (Web Preview Mode)')
