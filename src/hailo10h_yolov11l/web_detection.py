...
app = FastAPI(title="reComputer YOLOv11l Hailo-10H")
...
@app.post("/api/models/yolov11l/predict")
async def predict(
...
async def index():
    ...
    <html>
      <head>
        <title>reComputer YOLOv11l · Hailo-10H</title>
        <style>
...
def main():
    parser = argparse.ArgumentParser(description='YOLOv11l on CM5 + Hailo-10H (Web Preview Mode)')
