...
app = FastAPI(title="reComputer YOLOv11x Hailo-8")
...
async def index():
    ...
    <html>
      <head>
        <title>reComputer YOLOv11x · Hailo-8</title>
        <style>
...
def main():
    parser = argparse.ArgumentParser(description='YOLOv11x on RPi5 + Hailo-8 (Web Preview Mode)')
