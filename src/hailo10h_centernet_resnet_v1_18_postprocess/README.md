# CenterNet (resnet_v1_18) - COCO Object Detection

CenterNet object detection with a ResNet-18 backbone on Hailo-10H (COCO 80 classes).

## Model

| Property | Value |
|----------|-------|
| Architecture | CenterNet + ResNet-18 |
| Input | 512×512×3 RGB |
...
| `/api/models/centernet_resnet_v1_18_postprocess/predict` | POST | Detection boxes (JSON) |
