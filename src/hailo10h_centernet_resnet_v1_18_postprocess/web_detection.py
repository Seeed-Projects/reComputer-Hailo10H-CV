...
app = FastAPI(title="reComputer CenterNet (resnet_v1_18) Hailo-10H")
...
async def index():
    ...
    <html>
      <head>
        <title>reComputer CenterNet (resnet_v1_18) · Hailo-10H</title>
        <style>
      ...
      <body>
        <div class="container">
          <h1>CenterNet (resnet_v1_18) · RPi5 + Hailo-10H</h1>
...
def main():
    parser = argparse.ArgumentParser(description='CenterNet (resnet_v1_18_postprocess) on RPi5 + Hailo-10H (Web Preview Mode)')
