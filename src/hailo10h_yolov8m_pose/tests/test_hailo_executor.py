...
DEFAULT_OUTPUT_SPECS = [
    ("yolov8m_pose/conv70", [1, 20, 20, 64]),
    ("yolov8m_pose/conv71", [1, 20, 20, 1]),
    ("yolov8m_pose/conv72", [1, 20, 20, 51]),
    ("yolov8m_pose/conv57", [1, 40, 40, 64]),
    ("yolov8m_pose/conv58", [1, 40, 40, 1]),
    ("yolov8m_pose/conv59", [1, 40, 40, 51]),
    ("yolov8m_pose/conv43", [1, 80, 80, 64]),
    ("yolov8m_pose/conv44", [1, 80, 80, 1]),
    ("yolov8m_pose/conv45", [1, 80, 80, 51]),
]
...
class _InferModel:
    ...
    def input(self):
        return _ModelInfo("yolov8m_pose/input_layer1", [640, 640, 3])
...
class HailoExecutorTest(unittest.TestCase):
    ...
    def test_configuration_and_bindings_are_reused_across_frames(self):
        infer = self.executor.HailoInfer("model/yolov8m_pose.hef")
