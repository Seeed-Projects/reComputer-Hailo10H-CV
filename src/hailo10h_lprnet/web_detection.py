...
app = FastAPI(title="reComputer LPRNet Pipeline Hailo-10H")
...
async def index():
    ...
    <html><head><title>reComputer LPRNet Pipeline · Hailo-10H</title>
    <style>
    ...
    <div class="container"><h1>LPRNet License Plate Pipeline · CM5 + Hailo-10H</h1>
...
def main():
    parser = argparse.ArgumentParser(description='Tiny-YOLOv4 + LPRNet pipeline on CM5 + Hailo-10H')
