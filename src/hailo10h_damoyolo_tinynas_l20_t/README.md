# DAMO-YOLO (tinynasL20_T) on Raspberry Pi 5 / CM5 + Hailo-10H
...
```bash
sudo docker build -f docker/hailo10h/damoyolo_tinynas_l20_t.dockerfile \
  -t damoyolo_tinynas_l20_t:latest \
  src/rpi5_hailo10h_damoyolo_tinynas_l20_t
```
