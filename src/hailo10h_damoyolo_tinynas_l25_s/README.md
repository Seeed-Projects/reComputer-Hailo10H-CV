# DAMO-YOLO (tinynasL25_S) on Raspberry Pi 5 / CM5 + Hailo-10H
...
```bash
sudo docker build -f docker/hailo10h/damoyolo_tinynas_l25_s.dockerfile \
  -t damoyolo_tinynas_l25_s:latest \
  src/rpi5_hailo10h_damoyolo_tinynas_l25_s
```
