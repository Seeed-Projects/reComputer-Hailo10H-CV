...
app = FastAPI(title="reComputer DAMO-YOLO (tinynasL25_S) Hailo-10H")
...
async def index():
    ...
    <html>
      <head>
        <title>reComputer DAMO-YOLO (tinynasL25_S) · Hailo-10H</title>
        <style>
      ...
      <body>
        <div class="container">
          <h1>DAMO-YOLO (tinynasL25_S) · CM5 + Hailo-10H</h1>
...
def main():
    parser = argparse.ArgumentParser(description='DAMO-YOLO (tinynasL25_S) on CM5 + Hailo-10H (Web Preview Mode)')
