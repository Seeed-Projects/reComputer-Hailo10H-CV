...
# YOLOv11s outputs 80 classes (base config: classes=80,
...
app = FastAPI(title="reComputer YOLOv11s Hailo-8")
...
async def index():
    ...
    <html>
      <head>
        <title>reComputer YOLOv11s · Hailo-8</title>
        <style>
...
def main():
    parser = argparse.ArgumentParser(description='YOLOv11s on RPi5 + Hailo-8 (Web Preview Mode)')
