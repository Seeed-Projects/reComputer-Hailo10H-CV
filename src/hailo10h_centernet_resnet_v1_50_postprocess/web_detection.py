...
app = FastAPI(title="reComputer CenterNet (resnet_v1_50) Hailo-10H")
...
async def index():
    ...
    <html>
      <head>
        <title>reComputer CenterNet (resnet_v1_50) · Hailo-10H</title>
        <style>
      ...
      <body>
        <div class="container">
          <h1>CenterNet (resnet_v1_50) · RPi5 + Hailo-10H</h1>
...
def main():
    parser = argparse.ArgumentParser(description='CenterNet (resnet_v1_50_postprocess) on RPi5 + Hailo-10H (Web Preview Mode)')
