# CenterNet (resnet_v1_50) - COCO 目标检测

CenterNet（ResNet-50 骨干网络）在 Hailo-10H 上的 COCO 80 类目标检测。

## 模型信息

| 属性 | 值 |
|------|-----|
| 架构 | CenterNet + ResNet-50 |
| 输入 | 512×512×3 RGB |
...
| `/api/models/centernet_resnet_v1_50_postprocess/predict` | POST | 检测框（JSON） |
