...
parser.add_argument("--model_path", default=os.path.join(os.path.dirname(__file__), "model", "fcn8_resnet.hef"))
...
@app.get("/health")
async def health():
    return {"status": "ok", "model": "fcn8_resnet", "model_loaded": infer is not None}
