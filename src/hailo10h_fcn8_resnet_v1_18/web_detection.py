...
def post_process_hailo(hailo_output, obj_thresh, nms_thresh, input_h, input_w):
    ...
    if not _SEG_OUTPUT_LOGGED:
        ...
        print(
            f"[FCN8 ResNet-18] raw output shape={raw_shape}, decoded mask shape={class_mask.shape}, "
...
def main():
    parser = argparse.ArgumentParser(description='FCN8 ResNet-18 B0 BN semantic segmentation on CM5 + Hailo-10H (Web Preview Mode)')
